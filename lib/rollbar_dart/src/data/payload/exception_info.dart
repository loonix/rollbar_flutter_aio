...
@sealed
@immutable
class ExceptionInfo with EquatableSerializableMixin implements Equatable, Serializable {
  final String type;
  ...
  @override
  String toString() => 'ExceptionInfo(type: $type, message: $message, description: $description)';
