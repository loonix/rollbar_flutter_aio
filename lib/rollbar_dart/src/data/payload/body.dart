...
class Trace with Report, EquatableSerializableMixin {
  ...
  factory Trace.fromMap(JsonMap map) => Trace(exception: map.trace.exception, frames: map.trace.frames, rawTrace: map.trace.rawTrace);
...
extension _KeyValuePaths on JsonMap {
  ...
  Iterable<Breadcrumb> get telemetry => this['telemetry'].whereType<JsonMap>().map<Breadcrumb>(Breadcrumb.fromMap).toList();
