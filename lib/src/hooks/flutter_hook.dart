    ...
    if (!error.silent) {
      Rollbar.drop(
        Breadcrumb.error(
          ...
          extra: {'summary': error.summary.toDescription(), 'context': error.context?.toDescription(), 'info': error.information, 'diagnostics': error.diagnostics, 'library': error.library}.compact(),
        ),
      );
