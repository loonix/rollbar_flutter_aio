...
extension FlutterErrorDiagnostics on FlutterErrorDetails {
  List<String>? get information => informationCollector?.call().map((e) => e.toStringDeep()).toList();
  List<Map<String, dynamic>>? get diagnostics => informationCollector?.call().serialized();
}
