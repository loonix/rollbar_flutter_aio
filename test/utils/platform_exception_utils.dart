...
PlatformException androidPlatformException({
  ...
  final JsonMap topTrace = {
    'exception': <String, dynamic>{'description': 'Invalid counter state: 1', 'message': 'Invalid counter state: 1', 'class': 'java.lang.IllegalStateException'},
    'frames': [
      <String, dynamic>{
  ...
  final JsonMap body = () {
    if (createChain) {
      const JsonMap secondTrace = {
        'exception': {'message': 'Rethrown Error', 'class': 'java.lang.RethrownStuff'},
        'frames': [
  ...
  final message = 'com.rollbar.flutter.RollbarTracePayload: ${jsonEncode(platformTrace)}';
