...
import 'package:rollbar_flutter_aio/rollbar.dart' show Rollbar, RollbarFlutter;
...
class MyHomePageState extends State<MyHomePage> {
  ...
  void faultyMethod() {
    ...
    platform.faultyMethod().then((message) => setState(() => _faultyMsg = message)).catchError((e) => log(e), test: (_) => false);
  }
